...
class Profile extends Component {
    ...
    render() {
        return ( <div style={{width:'100%'}} >
            <PublicLayout paragraph='Streaming highly reliable and accurate qualitative
            data from trusted sources for lucid analysis and effective decision making.'
                ...
                <Grid container xs={12}  >
                        ...
                        <Grid xs={6} item justify='center'>
                            ...
                            <img src={logoName} alt="" srcset="" className='avatar'  /><br/>
                            <img src={Camera} alt="" srcset="" className='camera'  /><br/>
