...
class Login extends Component {
    ...
    render() {
        return ( <div style={{width:'100%'}} >
            <PublicLayout paragraph='Large volumes of diverse data systematically categorized
...
export  function CustomizedInputs() {
  ...
  return (
      ...
      <FormControl fullWidth >
        ...
        <BootstrapInput  id="username"  placeholder='Place holder          Additional text / icon'/>
        <br/>
        <label shrink htmlFor="bootstrap-input" className='label' >
          Password
        </label>
